# Copyright 2019 Xinwei Li Authors. All Rights Reserved.
...
def MobileNetV3_small(input_shape=None,
	...
	x = _bneck_block(x, kernel = 3, filters=16, alpha=alpha, stride=2,activation = "relu",se = True,
	...
	x = _bneck_block(x, kernel = 5, filters=24, alpha=alpha, stride=1,activation = "relu",se = False,
	...
	x = _bneck_block(x, kernel = 3, filters=40, alpha=alpha, stride=1,activation = "hswish",se = True,
							expansion=240, block_id=4)
	x = _bneck_block(x, kernel = 3, filters=40, alpha=alpha, stride=1,activation = "hswish",se = True,
							expansion=240, block_id=5)
	x = _bneck_block(x, kernel = 3, filters=48, alpha=alpha, stride=1,activation = "hswish",se = True,
							expansion=120, block_id=6)
	x = _bneck_block(x, kernel = 3, filters=48, alpha=alpha, stride=1,activation = "hswish",se = True,
							expansion=144, block_id=7)

	x = _bneck_block(x, kernel = 3, filters=96, alpha=alpha, stride=2,activation = "hswish",se = True,
							expansion=288, block_id=8)
	x = _bneck_block(x, kernel = 3, filters=96, alpha=alpha, stride=1,activation = "hswish",se = True,
							expansion=576, block_id=9)
	x = _bneck_block(x, kernel = 5, filters=96, alpha=alpha, stride=1,activation = "hswish",se = True,
